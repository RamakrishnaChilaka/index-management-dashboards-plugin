...
class DataStreams extends Component<DataStreamsProps, DataStreamsState> {
  ...
  constructor(props: DataStreamsProps) {
    ...
    const {
      ...
      dataSourceId = DEFAULT_QUERY_PARAMS.dataSourceId,
      dataSourceLabel = DEFAULT_QUERY_PARAMS.dataSourceLabel
              ...
              actions={[
                ...
                },
                {
                  ...
                  buttonProps: {
                    fill: true,
                    onClick: () => {
                      this.props.history.push(`${ROUTES.CREATE_DATA_STREAM}?dataSourceId=${this.state.dataSourceId}&dataSourceLabel=${this.state.dataSourceLabel}`);
                    },
                  },
                },
              ]}
          ...
          title={
            <>
              ...
              <EuiFormRow
                ...
                helpText={
                  <div>
                    Data streams simplify the management of time-series data. Data streams are composed of multiple
                    backing indexes. Search
                    requests are routed to all backing indexes, while indexing requests are routed to the latest write
                    index.{' '}
            ...
            noItemsMessage={
              isEqual(
                ...
                <EuiEmptyPrompt
                  body={
                    <EuiText>
                      <p>There are no data streams matching your applied filters. Reset your filters to view your data
                        streams.</p>
                    </EuiText>
                  }
                  actions={[
